package ma.fstm.ilisi2.ExpertSysCovid19.view.client;
...
import ma.fstm.ilisi2.ExpertSysCovid19.controller.HandlerClient;
	...
	public InterfaceEssaie() {
		...
		btnAjouter_tous.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
						...
						try {
							diagnostic= new HandlerClient().Traitement(diagnostic);
